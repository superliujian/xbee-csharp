...
namespace Examples.Communication.SendDataAsyncSample
{
	/// <summary>
	/// XBee C# Library Send Data Asynchronously sample application.
	/// </summary>
	/// <remarks>
	/// This example sends data asynchronously to a remote device whose Node 
	/// Identifier is 'REMOTE'.
	/// 
	...
	public class MainApp
	{
		...
		{
			Console.WriteLine(" +-------------------------------------------------+");
			Console.WriteLine(" |  XBee C# Library Send Data Asynchrously Sample  |");
			Console.WriteLine(" +-------------------------------------------------+\n");
