  Introduction
  ------------
  This sample C# application shows how to send IP data from an IP device to 
  another one connected to the Internet using the XBee C# Library.

  The application sends IP data to another Cellular device on the network with a 
  ...
  -----
    * MainApp.cs:
      Main application class. It instantiates a Cellular device, establishes a 
  ...
  To run this example you will need:
    ...
    * At least two XBee Cellular radios in API mode and their corresponding carrier
