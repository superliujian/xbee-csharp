...
namespace Examples.Communication.Explicit.SendExplicitDataAsyncSample
{
	/// <summary>
	/// XBee C# Library Send Explicit Data Asynchronously sample application.
	/// </summary>
	/// <remarks>
	/// This example sends data in application layer (explicit) format 
	/// asynchronously to a remote device whose Node Identifier is 'REMOTE'.
	/// 
	...
	public class MainApp
	{
		...
		{
			Console.WriteLine(" +----------------------------------------------------------+");
			Console.WriteLine(" |  XBee C# Library Send Explicit Data Asynchrously Sample  |");
			Console.WriteLine(" +----------------------------------------------------------+\n");
			...
			try
			{
				...
				{
					Console.WriteLine(">> Sending explicit data asynchronously to {0} [{1} - {2} - {3} - {4}] >> {5} | {6}... ",
					...
					myDevice.SendExplicitDataAsync(remoteDevice, Convert.ToByte(SOURCE_ENDPOINT), Convert.ToByte(DESTINATION_ENDPOINT),
