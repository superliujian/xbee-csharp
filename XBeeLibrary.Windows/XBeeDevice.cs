...
namespace XBeeLibrary.Windows
{
	...
	public class XBeeDevice : Core.XBeeDevice
	{
		/// <summary>
		/// Class constructor. Instantiates a new <see cref="XBeeDevice"/> object with the given 
		/// parameters.
		/// </summary>
		/// <param name="port">Serial port name where device is attached to.</param>
